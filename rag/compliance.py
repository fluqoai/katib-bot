...
10. **قالب الجمعية الإلزامي**: يجب أن يكون ترتيب الخطاب: الافتتاحية،
    الموضوع، السلام، `أما بعد،`، المتن، ثم عبارة الختام واسم الجمعية.
    الافتتاحية وعبارة `وتفضلوا بقبول خالص الشكر والتقدير،،` واسم
    `جمعية الدعوة وتوعية الجاليات بمحافظة القطيف` عناصر قالب ثابتة؛
    لا تعاملها كادعاءات تحتاج إلى citation ولا تقترح حذفها أو تغييرها.
    كما أن `{{recipient_name}}` و`{{موضوع_الخطاب}}` مقبولان حصراً عند
    عدم إدخال المستخدم لهذه البيانات.
